...
public class HashCodeEx1 {
    public static void main(String[] args) {
        ...
        // Желательно чтобы ключ в HashMap был всегда неизменным(Этого можно достичь с помощью константы final,
        // которую можно поставить в классе, либо указать в полях переменных). Если же они будут изменны,
        // то будет меняться сам HashCode.
